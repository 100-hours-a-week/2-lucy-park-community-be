...
public class UpdateCommentTest {
    ...
    @Test
    @DisplayName("댓글 수정 성공 - 수정 권한 있음")
    void should_ReturnVoid_When_UpdateComment_Success() {
       ...
       Comment comment = Comment.builder()
        ...
        commentService.updateComment(2L, 2L, requestDto);
    ...
    @Test
    @DisplayName("댓글 수정 실패 - 게시글 존재하지 않음")
    void should_ReturnError_When_PostNotFOund() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            commentService.updateComment(1L, 2L, requestDto);
        });
    ...
    void should_ReturnError_When_CommentNotFOund() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> {
            commentService.updateComment(post.getId(), 2L, requestDto);
        });
